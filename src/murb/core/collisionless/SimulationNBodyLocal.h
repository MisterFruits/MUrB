 ...
 * \brief   Abstract n-body collision less simulation class for local computations (inside a node).
 * \author  A. Cassagne
 * \date    2014
 *
 * \section LICENSE
 ...
 * \brief  Abstract n-body simulation class for local computations (inside a node).
 *
 * \tparam T : Type.
 */
