...
// 19 flops
template <typename T>
void SimulationNBodyV3Intrinsics<T>::computeAccelerationBetweenTwoBodies(const mipp::vec &rG,
                                                                         ...
                                                                         const mipp::vec &rqjZ)
{
	...
	mipp::vec rrijSquared = rSoftSquared;
...
// 20 flops
template <>
void SimulationNBodyV3Intrinsics<float>::computeAccelerationBetweenTwoBodies(const mipp::vec &rG,
                                                                             const mipp::vec &rSoftSquared,
                                                                             const mipp::vec &rqiX,
                                                                             const mipp::vec &rqiY,
                                                                             const mipp::vec &rqiZ,
