...
template <typename T>
void SimulationNBodyV2Intrinsics<T>::_computeBodiesAcceleration()
{
...
template <typename T>
void SimulationNBodyV2Intrinsics<T>::computeBodiesAcceleration()
{
	this->_computeBodiesAcceleration();
}

template <>
void SimulationNBodyV2Intrinsics<float>::computeBodiesAcceleration()
{
	this->_computeBodiesAcceleration();
