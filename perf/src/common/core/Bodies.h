...
protected:
	...
	unsigned long  nVecs;          /*!< Number of vectors (nVecs = n / nbOfElementsInOneVector). */
...
public:
     ...
     *
     *  \param accelerations : The array of accelerations needed to compute new positions and velocities.
